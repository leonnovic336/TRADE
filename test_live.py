...
# ==========================================
# TEST 1: CORE TRADING STRATEGIES (LIVE DATA)
# ==========================================
...
def test_trading_strategies():
    ...
    from src.trading_knowledge.strategies import (
        ...
        StrategyManager, PatternRecognizer
    )
...
# ==========================================
# TEST 2: MULTI-ASSET CLASS (LIVE DATA)
# ==========================================
...
def test_multi_asset():
    ...
    for asset_class, symbols in assets:
        print(f"\n  📦 {asset_class}:")
        for symbol in symbols[:3]:  # Limit to 3 per class
            try:
                ticker = yf.Ticker(symbol)
                info = ticker.info
...
print("✅ Multi-Asset Classes: Stocks, ETF, Crypto, Forex, Commodities, Indices")
